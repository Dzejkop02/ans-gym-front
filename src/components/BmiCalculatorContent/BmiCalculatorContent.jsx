                ...
                <div className="bmi-calc__main">
                    <div className="bmi-calc__calculator gradient">
                        <div className="bmi-calc__calculator-top">
                            ...
                            <form className="bmi-calc__form" onSubmit={handleFormSubmit}>
                                <div className="bmi-calc__grid">
                                    ...
                                    <div className="bmi-calc__group">
                                        ...
                                        <input className="input-radio" type="radio" id="k" name="sex" value="k"
                                               checked={!male} onChange={() => setMale(!male)}/>
                                        <label htmlFor="m" className="bmi-calc__label">M</label>
                                        <input className="input-radio" type="radio" id="m" name="sex" value="m"
                                               checked={male} onChange={() => setMale(!male)}/>
                                    </div>

                                    <label htmlFor="weight" className="bmi-calc__label">Waga:</label>
                                    <input className="input input--bmi" id="weight" type="number" placeholder="kg"
                                           value={weight || ''}
                                           onChange={e => setWeight(+e.target.value)}/>

                                    <label htmlFor="height" className="bmi-calc__label">Wzrost:</label>
                                    <input className="input input--bmi" id="height" type="number" placeholder="cm"
                                           value={height || ''}
                            ...
                            {result ? <p className="bmi-calc__result">{result}</p> :
                                <p className="bmi-calc__result">&nbsp;</p>}
                        </div>
                    ...
                    <div className="bmi-calc__description gradient">
                        <div className="bmi-calc__description-top">
                            ...
                            <p className="bmi-calc__p">Kalkulator BMI (Body Mass Index) daje każdemu możliwość szybkiego
                                i
                                wygodnego obliczenia własnego wskaźnika masy ciała. BMI obliczamy dzieląc masę ciała (w
                                kilogramach) przez wzrost do kwadratu (w metrach). Wskaźnik ten wykorzystywany jest
                                przede
                                wszystkim do oceny ryzyka pojawienia się groźnych chorób: miażdżycy, choroby
                                niedokrwiennej
                                serca, udaru mózgu, czy nawet nowotworów. Większość tych chorób jest związana z
                                otyłością i
                        ...
                        <div className="bmi-calc__description-bottom">
                            ...
                            <p className="bmi-calc__p--small">Kalkulator BMI obrazuje przybliżoną zawartość tłuszczu w
                                organizmie. W przypadku niektórych osób wskaźnik BMI może sugerować błędne wnioski.
                                Osoby
